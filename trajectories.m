...
% TRAJECTORIES MATLAB code for trajectories.fig
...
% Last Modified by GUIDE v2.5 03-Apr-2018 16:51:28
...
% varargin   command line arguments to trajectories (see VARARGIN)

% Choose default command line output for trajectories
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes trajectories wait for user response (see UIRESUME)
