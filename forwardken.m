...
%}
function [x,y,z,alpha,beta]=forwardken(theta,theta2,theta3,theta4,theta5)
...
A = (C2*C3)-(S2*S3);
B = C2*S3 + C3*S2; 
%%%%2*cos(theta)*(36*sin(theta2 + theta3 + theta4)+80*sin(theta2 + theta3)+125*sin(theta2))
x = 2*cos(theta)*(36*sin(theta2 + theta3 + theta4) + 80*sin(theta2 + theta3) + 125*sin(theta2));
y = 2*sin(theta)*(36*sin(theta2 + theta3 + theta4) + 80*sin(theta2 + theta3) + 125*sin(theta2));
z = 72*cos(theta2 + theta3 + theta4) + 160*cos(theta2 + theta3) + 250*cos(theta2) + 300;
